...
@section('title', 'Modifier les Informations de l\'École')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Modifier les Informations de l'École</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title">Modifier les Informations de l'École</h3>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="adresse" 
                                               name="adresse" 
                                               value="{{ old('adresse', $school->adresse) }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('social_links.facebook', $school->social_links['facebook'] ?? '') }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('social_links.instagram', $school->social_links['instagram'] ?? '') }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('social_links.linkedin', $school->social_links['linkedin'] ?? '') }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="url" 
                                                   ...
                                                   value="{{ old('social_links.tiktok', $school->social_links['tiktok'] ?? '') }}" 
