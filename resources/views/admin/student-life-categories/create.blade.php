...
@section('title', 'Créer une Catégorie de Vie Étudiante')
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nouvelle Catégorie de Vie Étudiante</h3>
                </div>
                <form action="{{ route('admin.student-life-categories.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
